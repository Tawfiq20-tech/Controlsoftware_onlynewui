...
export const BUILT_IN_PROFILES: BuiltInMachineProfile[] = [
    {
        id: 'onefinity-apprentice',
        name: 'Onefinity Apprentice',
        description: 'Onefinity Apprentice — 419 × 419 × 133 mm work area. Compact desktop precision CNC router.',
        workArea:     { x: 419,  y: 419,  z: 133 },
    ...
    },
    {
        ...
        description: 'Onefinity Woodworker — 838 × 838 × 133 mm work area. Rigid dual-rail X/Y motion, standard shop size.',
        workArea:     { x: 838,  y: 838,  z: 133 },
        maxFeed:      { x: 5080, y: 5080, z: 2540 },
        acceleration: { x: 508,  y: 508,  z: 381 },
        stepsPerMm:   { x: 200,  y: 200,  z: 200 },
        spindleMaxRpm: 24000,
    ...
    },
    {
        ...
        description: 'Onefinity Journeyman — 1245 × 838 × 133 mm work area. Wide format for cabinet doors and furniture panels.',
        workArea:     { x: 1245, y: 838,  z: 133 },
        maxFeed:      { x: 5080, y: 5080, z: 2540 },
        acceleration: { x: 508,  y: 508,  z: 381 },
        stepsPerMm:   { x: 200,  y: 200,  z: 200 },
        spindleMaxRpm: 24000,
    ...
    },
    {
        ...
        name: 'Onefinity Foreman',
        description: 'Onefinity Foreman — 1245 × 1248 × 133 mm work area. Full sheet half-sheet professional production capacity.',
        workArea:     { x: 1245, y: 1248, z: 133 },
        maxFeed:      { x: 5080, y: 5080, z: 2540 },
        acceleration: { x: 508,  y: 508,  z: 381 },
        stepsPerMm:   { x: 200,  y: 200,  z: 200 },
        spindleMaxRpm: 24000,
